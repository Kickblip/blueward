  ...
  return (
    <div className="max-w-7xl w-full mx-auto flex justify-between py-4 font-oswald">
      <div className="flex items-center gap-8">
        ...
        <span className="relative inline-block mt-1">
          <Link href="/wagers" className="font-medium uppercase text-md hover:text-zinc-300 transition-colors duration-200">
            Wagers
          </Link>
          <span className="pointer-events-none absolute -top-3 -right-3 -rotate-15">
