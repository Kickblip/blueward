...
export default function Page() {
  return (
    <>
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,#7f1d1d99,transparent_70%)] md:rounded-xl"
      />
      <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-8">
        <h1 className="font-oswald text-7xl font-semibold uppercase italic">
          Leaderboard
        </h1>
