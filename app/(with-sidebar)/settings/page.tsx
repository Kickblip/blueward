  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-xl flex-col gap-16 pb-16">
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4 rounded-md bg-[#D13639] p-4 text-white">
          <SiRiotgames className="size-6" />

          <div className="flex items-end gap-1">
            <p className="font-oswald text-2xl font-semibold uppercase">
              {player?.riotIdGameName}
            </p>
            <p className="font-semibold">#{player?.riotIdTagline}</p>
          </div>
        </div>
      </section>
              ...
              <FieldSet>
                ...
                >
                  ...
                  <Field orientation="horizontal">
                    ...
                    />
                    <FieldLabel htmlFor="rejected-support">Support</FieldLabel>
                  </Field>
                </FieldGroup>
              </FieldSet>
              <FieldSet>
                ...
                >
                  ...
                  <Field orientation="horizontal">
                    ...
                    />
                    <FieldLabel htmlFor="disliked-support">Support</FieldLabel>
                  </Field>
                </FieldGroup>
              </FieldSet>
            </FieldSet>
