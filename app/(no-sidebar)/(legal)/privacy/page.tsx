      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <article className="space-y-8">
          <p className="text-sm leading-6 text-zinc-200">
            ...
            <TextLink href="/">blueward.lol</TextLink>. By using Blueward, you
            agree to the terms of this Privacy Policy and{" "}
          ...
          <Section title="1. Personal Data">
            <p>
              ...
              of which may be non-public.
            </p>
          </Section>

          <Section title="2. Non-Personal Data">
            <p>
              We may use basic analytics such as page views, browser type, and
              other device details. This data helps us analyze trends and
              improve our services. We do not use cookies on Blueward.
            </p>
          </Section>
